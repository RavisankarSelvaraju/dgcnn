...
def split_data(source_dir, destination_dir , ratio = (.8, .2)):

    print("Splitting dataset...")
    splitfolders.ratio(source_dir, output = destination_dir, seed=1337, ratio=(.8, .2), group_prefix=None, move=False) # default values
    print("Done")


# ======================================== utilites for dataset =========================================================
